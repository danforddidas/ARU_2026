...
if DEBUG: ALLOWED_HOSTS += ["127.0.0.1", "localhost"]
INSTALLED_APPS = ["django.contrib.admin","django.contrib.auth","django.contrib.contenttypes","django.contrib.sessions","django.contrib.messages","django.contrib.staticfiles","corsheaders","rest_framework","rest_framework.authtoken","repository"]
...
DATABASES = {"default": dj_database_url.parse(DATABASE_URL, conn_max_age=600, ssl_require=not DEBUG)} if DATABASE_URL else {"default":{"ENGINE":"django.db.backends.sqlite3","NAME":BASE_DIR/"db.sqlite3"}}
...
if not CORS_ALLOWED_ORIGINS and DEBUG: CORS_ALLOW_ALL_ORIGINS=True
